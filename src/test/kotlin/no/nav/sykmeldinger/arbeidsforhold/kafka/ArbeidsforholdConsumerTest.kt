...
object ArbeidsforholdConsumerTest : FunSpec({
    ...
    context("ArbeidsforholdConsumer - handleArbeidsforholdHendelse") {
        ...
        test("Lagrer nytt arbeidsforhold og sletter arbeidsforhold som har blitt utdatert") {
            coEvery { arbeidsforholdClient.getArbeidsforhold(any()) } returns listOf(
                AaregArbeidsforhold(
                    1,
                    Arbeidssted(ArbeidsstedType.Underenhet, listOf(Ident(IdentType.ORGANISASJONSNUMMER, "123456789", true))),
    ...
    context("ArbeidsforholdConsumer - getArbeidsforholdSomSkalSlettes") {
        test("Returnerer tom liste hvis arbeidsforhold-listene inneholder de samme elementene") {
            val arbeidsforholdAareg = listOf(
                Arbeidsforhold(
                    id = 1,
                    fnr = "12345678901",
                    orgnummer = "123456789",
        ...
        test("Returnerer tom liste hvis aareg-arbeidsforhold inneholder flere elementer enn arbeidsforholdDb-listen") {
            val arbeidsforholdAareg = listOf(
                Arbeidsforhold(
                    id = 1,
                    fnr = "12345678901",
        ...
        test("Returnerer liste med id hvis arbeidsforholdDb inneholder element som ikke finnes i  enn aareg-listen") {
            val arbeidsforholdAareg = listOf(
                Arbeidsforhold(
                    id = 1,
                    fnr = "12345678901",
